...
// =========================================================
// LANDFORCES RECRUITMENT CHAINS
//
// Chain 1: OATHSTONE — Early Game    (no building required)
// Chain 2: IRON_PACT — Mid Game      (requires building:garrison)
// Chain 3: IRON_MEET — Late Game     (requires building:garrison + building:training_yard)
// =========================================================

export const landforcesChainDefs: Request[] = [
          ...
          followUpBoosts: [
            {
              ...
              boostType: 'linear',
              boostValue: 3,
              description: 'Strengthens persuasive power — more men accept the calling',
            },
          ],
        },
      },
    ...
    followUps: [
      {
        ...
        delayMaxTicks: 4,
        candidates: [
          { requestId: 'OATHSTONE_MEMBER_COMPLIANCE', weight: 1 },
          ...
          followUpBoosts: [
            {
              ...
              boostType: 'linear',
              boostValue: 4,
              description: 'Increases the likelihood that high-ranking fighters make the journey',
            },
          ],
        },
      },
    ...
    followUps: [
      {
        ...
        delayMaxTicks: 5,
        candidates: [
          { requestId: 'IRON_MEET_MEMBER_GRAND_TOURNEY', weight: 1 },
